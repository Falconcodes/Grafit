...
#define MAX_PWM_1 17 //процент от максимальной мощности, до которого уменьшится мощность
...
{#asm ("sei");     
 ...
 //while (!START); //если установка с электрозамком - ждем, когда на входе Старт появится высокий уровень, до тех пор стоим на месте. Если Старт уже был включен - проходим мимо
